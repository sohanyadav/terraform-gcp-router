...
| <a name="input_managedby"></a> [managedby](#input\_managedby) | ManagedBy, sohanyadav | `string` | `""` | no |
...
| <a name="input_repository"></a> [repository](#input\_repository) | Terraform current module repo | `string` | `"https://github.com/sohanyadav/terraform-gcp-router"` | no |
